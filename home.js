...
// I am not sure what is wrong with this, but it says that the username is never called. Isn't 
// it called when you type the arrow function? 
...
const canWeDeliver = zipCode => {
    ...
    return console.log('Sorry we cannot deliver to your address')
}
...
const canWeDeliverThree = zip => {
    ...
    filteredZip.length > 0 ? console.log('youre in the zone') : console.log('sorry we cant deliver')
}
